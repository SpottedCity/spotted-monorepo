      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.profileImageContainer}>
            {/* Wyświetlamy podgląd (previewUri) LUB prawdziwy awatar pobrany z bazy */}
            <AvatarProgress
              imageUrl={previewUri || user?.avatar}
...
const styles = StyleSheet.create({
  ...
  profileImageContainer: { alignItems: 'center', marginTop: SIZES.lg, marginBottom: SIZES.xl },
  nameRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  name: { fontSize: SIZES.h2, fontWeight: 'bold', color: Colors.primary },
  nameEditBtn: { marginLeft: SIZES.sm, padding: SIZES.xs },
  role: { fontSize: SIZES.body_sm, color: '#64748B', fontWeight: '500', marginTop: SIZES.xs },
  buttonContainer: { marginTop: 'auto', paddingBottom: SIZES.bottom_tab_height },
  statsCard: {
    flexDirection: 'row',
  ...
  statValue: { fontSize: SIZES.h3, fontWeight: 'bold', color: Colors.primary, marginBottom: 2 },
  statLabel: {
    fontSize: SIZES.tiny,
  ...
  statDivider: { width: 1, backgroundColor: Colors.border, marginVertical: SIZES.sm },
  menuCard: {
    backgroundColor: Colors.white,
    borderRadius: SIZES.radius_lg,
    overflow: 'hidden',
